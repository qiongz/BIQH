...
public:
     ...
     */
    void peer_set_hamil(int id, long nbatch,long nrange,double theta_x,,int theta_sym);
    void set_hamil(double _lx, double _ly, long _nphi,long _nLL, double _d,double theta_x, int theta_sym,int nthread);
